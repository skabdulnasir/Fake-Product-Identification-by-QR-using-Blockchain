...
class Register:
    def __init__(self,root):
        ...
        title=Label(frame1,text="USER REGISTRATION",font=("times new roman",20,"bold"),bg="white",fg="green").place(x=50,y=40)
    ...
    def register_data(self):
        if self.txt_fname.get()=="" or self.txt_Lname.get()=="" or self.txt_contact.get()=="" or self.txt_email.get()=="" or self.txt_password.get()=="" or self.txt_cpass.get()=="":
            ...
            try:
                con=pymysql.connect(host="localhost",user="root",password="Nasir@9593",database="nasir2")
                cur=con.cursor()
